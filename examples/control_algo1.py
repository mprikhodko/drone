...
class Actor(nn.Module):
    def __init__(self, state_dim, action_dim):
        ...
        self.fc1 = nn.Linear(state_dim, 10*256)
        self.fc2 = nn.Linear(10*256, 256)
...
class DDPGAgent:
    def __init__(self, state_dim, action_dim, action_high):
        ...
        self.actor_optimizer = optim.Adam(self.actor.parameters(), lr=1)
        self.critic_optimizer = optim.Adam(self.critic.parameters(), lr=1)

        self.buffer = ReplayBuffer(buffer_size=1000000)
        self.batch_size = 128
        self.gamma =0.9
        self.tau = 0.005
    ...
    def train(self):
        ...
        nn_utils.clip_grad_norm_(self.critic.parameters(), 1)
        ...
        nn_utils.clip_grad_norm_(self.actor.parameters(), 1)
        self.soft_update()
        #print(actor_loss)
